...
def get_dataset(args, sparse=True, cleaned=False, normalize=False):
    ...
    if args.n_patches > 0:
        subgraph_transform = GraphPartitionTransform(static_weights=args.static_weights, n_patches=args.n_patches,
                                                     ...
                                                     ablate_R_intra=args.ablate_R_intra,
                                                     ablate_R_balance=args.ablate_R_balance,
                                                     ablate_R_comm=args.ablate_R_comm,
                                                     ablate_policy_network=args.ablate_policy_network,
                                                     ablate_value_network=args.ablate_value_network)
